...
namespace HotelPriceScout.Data.Interface
{
    ...
    {
        public static List<PriceModel> PriceListGenerator(DateTime todayDate, IEnumerable<PriceModel> monthData,
            decimal avgPrice)
        {
            List<PriceModel> priceDataList = new List<PriceModel>();
        ...
        {
            return list.Find(priceModel => priceModel.HotelName == "Average Market Price");
        }
    }
}
